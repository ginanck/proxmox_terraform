locals {
  ...
  master_nodes = {
    "k8s-master01" = { name = "k8s-master01", vm_id = 301, ip_address = "172.16.3.101/23" }
    "k8s-master02" = { name = "k8s-master02", vm_id = 302, ip_address = "172.16.3.102/23" }
    "k8s-master03" = { name = "k8s-master03", vm_id = 303, ip_address = "172.16.3.103/23" }
  }
